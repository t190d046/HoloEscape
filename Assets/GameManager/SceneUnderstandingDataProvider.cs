    ...
    public class SceneUnderstandingDataProvider : MonoBehaviour
    {
        ...
        private async void Start()
        {
            if (RunOnDevice)
            {
                ...
                {
                    UnityEngine.Debug.Log("SceneUnderstandingDataProvider.Start: Running in editor with the RunOnDevice mode set is not supported.");
                ...
                if (SceneUnderstanding.SceneObserver.IsSupported())
                {
                    ...
                    {
                        UnityEngine.Debug.Log("SceneUnderstandingDataProvider.Start: Access to Scene Understanding has been denied. Reason: " + access);
                ...
                {
                    UnityEngine.Debug.Log("SceneUnderstandingDataProvider.Start: Scene Understanding not supported.");
        ...
        private void RetrieveData(float boundingSphereRadiusInMeters, bool enableQuads, bool enableMeshes, bool enableInference, bool enableWorldMesh, SceneUnderstanding.SceneMeshLevelOfDetail lod)
        {
            ...
            UnityEngine.Debug.Log(string.Format("SceneUnderstandingDataProvider.RetrieveData: Completed. Radius: {0}; Quads: {1}; Meshes: {2}; Inference: {3}; WorldMesh: {4}; LOD: {5}; Bytes: {6}; Time (secs): {7};",
